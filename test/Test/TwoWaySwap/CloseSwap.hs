...
module Test.TwoWaySwap.CloseSwap
  ( 
    -- * Scenarios Tested
...
regressionTest3 = do
  let -- Seller Info
      ...
      swapDatum3 = 
        genSwapDatum (offer3,ask3) (unsafeRatio 1_000_000 1) (unsafeRatio 1_000_000 1) Nothing Nothing
...
-- | Close a single valid Swap UTxO. The swap expires after an 1 min.
